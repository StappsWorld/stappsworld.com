export const proj_arr = [
  {
    ...
    tools: ["rust"],
    description:
      "<u><strong>A Rusty implementation of BpyTop</strong></u>, a stronger, more informative Top written in Python. I ported this program to Rust as a means of immersing myself further the language. It is fully memory safe.",
    loc: 50000,
  ...
  },
  {
    ...
    tools: ["rust"],
    description:
      "Some <u><strong>OpenGL demos</strong></u> written in Rust. A bit of an on and off collection of graphical projects when I feel like writing something creative.",
    loc: 30000,
