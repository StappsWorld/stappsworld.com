...
export const employment_arr = [
    ...
    },
    {
        ...
        role: "Volunteer Mentor and Teacher Aid",
        time_started: new Date('Jan 1, 2018 00:00:00'),
        time_ended: null,
    },
    {
        name: "Community Ministry Center",
        url: "http://communityministrycenter.org/",
        role: "Volunteer IT Consultant",
        time_started: new Date('Jan 1, 2018 00:00:00'),
        time_ended: new Date('August 1, 2018 00:00:00'),
    },
]

export const education_arr = [
    {
        establishment: "George Mason University",
        title: "Master of Computer Science (MCS)",
        time_started: new Date('August 1, 2020'),
